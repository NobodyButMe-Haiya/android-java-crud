...
public class UpdateService {
    ...
    public UpdateService(View view1, FragmentActivity fragmentActivity1,NavController navController1) {
    ...
    private void getDataFromServer(String response){
        ...
        try {
            ...
            // we forget this part success:true  or success:false only the return in json
